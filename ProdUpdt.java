 ...
 * @author Biswadeb
 */
public class ProdUpdt extends javax.swing.JFrame {
 Connection con;
 ...
 ResultSet rs;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Search by Prod ID");
         ...
         if(rs.next())
            {
             ...
             t3.setText(rs.getString("pquant"));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
         Class.forName("oracle.jdbc.OracleDriver");
         con= DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:XE","NIVT","1234");
         ps=con.prepareStatement("update product set pname='"+t2.getText()+"',pquant='"+t3.getText()+"',pprice='"+t4.getText()+"' where pid='"+t1.getText()+"'");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProdUpdt.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
